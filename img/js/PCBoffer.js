...
//    assembly下的列表切换 第二个个盒子里的js第二个个盒子里的js第二个个盒子里的js
    $('.assem-parts>div').click(function () {
        ...
        $(this).children('.parts-pic').css({backgroundColor: '#b21f1f', color: '#ffffff'});
        if (assemIndex === 0) {
            $(this).children('.parts-pic').children('img').attr('src', 'img/images/turnkeyed.png');
            getassem.eq(1).children('.parts-pic').children('img').attr('src', 'img/images/kitt.png');
            getassem.eq(2).children('.parts-pic').children('img').attr('src', 'img/images/combo.png');
        }
        if (assemIndex === 1) {
            $(this).children('.parts-pic').children('img').attr('src', 'img/images/kitted.png');
            getassem.eq(0).children('.parts-pic').children('img').attr('src', 'img/images/turnkey.png');
            getassem.eq(2).children('.parts-pic').children('img').attr('src', 'img/images/combo.png');
        }
        if (assemIndex === 2) {
            $(this).children('.parts-pic').children('img').attr('src', 'img/images/comboed.png');
            getassem.eq(0).children('.parts-pic').children('img').attr('src', 'img/images/turnkey.png');
            getassem.eq(1).children('.parts-pic').children('img').attr('src', 'img/images/kitt.png');
        }
        $(this).siblings().children('.parts-sign').hide();
        $(this).siblings().children('.parts-pic').css({backgroundColor: '#efefefef', color: '#2e2525'});
    });
//js-assem
//   模拟点击计算按钮【简易】
